...
import { I as Input, L as Button, V as toast, a as pb, at as createLucideIcon, g as ScrollBar, h as ScrollArea, t as Label } from "./index-DGvWxLYe.js";
import { i as TabsTrigger, n as TabsContent, r as TabsList, t as Tabs } from "./tabs-HKzXS95f.js";
import { a as CardHeader, n as CardContent, o as CardTitle, r as CardDescription, t as Card } from "./card-Bbf0jma7.js";
...
var CLIENT_TEMPLATE_URL = "data:text/csv;charset=utf-8," + encodeURIComponent("Nome,Sobrenome,Celular,Fone Secundário,Nascimento,Profissional,Localização\n");
var PRODUCT_TEMPLATE_URL = "data:text/csv;charset=utf-8," + encodeURIComponent("Produto,Categoria,Preço de Venda,Preço de Custo,Estoque Atual\n");
var SUPPLIER_TEMPLATE_URL = "data:text/csv;charset=utf-8," + encodeURIComponent("Nome,CPF/CNPJ,Endereço,Pessoa de Contato,WhatsApp/Fone,Categoria\n");
function Settings() {
	...
	const handleImport = async (e, type) => {
		...
		reader.onload = async (event) => {
			...
			let errorCount = 0;
			try {
				if (type === "clientes") for (const row of data) try {
					let birthDate = "";
					if (row["Nascimento"]) {
						const parts = row["Nascimento"].split("/");
						if (parts.length === 3) birthDate = `${parts[2]}-${parts[1]}-${parts[0]} 12:00:00.000Z`;
					}
					await pb.collection("clients").create({
						...
						location_type: row["Localização"]?.toLowerCase() === "passagem" ? "passage" : "nearby",
						is_active: true
					});
					successCount++;
				} catch (err) {
				...
				else if (type === "produtos") for (const row of data) try {
				...
				else if (type === "fornecedores") for (const row of data) try {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(ScrollArea, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsList, {
						...
						"data-prohibitions": "[]",
						className: "inline-flex h-12 items-center justify-start rounded-none bg-transparent p-0 w-max min-w-full",
						children: [
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								"data-prohibitions": "[]",
								className: "text-sm text-muted-foreground",
								children: "Configuração de permissões para administradores, sócios e autônomos."
							})
						})]
					})
				}),
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardTitle, {
								...
								"data-prohibitions": "[]",
								children: "Importe seus dados em massa a partir de planilhas CSV para popular o sistema rapidamente."
							})]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										"data-prohibitions": "[]",
										className: "flex flex-col border rounded-xl p-5 bg-card text-card-foreground shadow-sm h-full",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
												...
												children: "Importe sua base de clientes com contato e data de nascimento."
											})]
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
												...
												"data-prohibitions": "[]",
												className: "text-sm text-muted-foreground mt-1",
												children: "Atualize seu estoque com produtos, categorias e preços."
											})]
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
												...
												"data-prohibitions": "[]",
												className: "text-sm text-muted-foreground mt-1",
												children: "Adicione a lista de fornecedores com seus respectivos contatos."
											})]
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
											...
											"data-prohibitions": "[]",
											children: "Preencha os dados seguindo o cabeçalho (não altere os nomes das colunas)."
										}),
