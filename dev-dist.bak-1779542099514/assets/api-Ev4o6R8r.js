import { a as pb } from './index-C5u061c7.js'
//#region src/services/api.ts
var getClients = (filter) =>
...
var getProductPurchasesByClient = (clientId) =>
  pb.collection('product_purchases').getFullList({
    filter: `client_id='${clientId}'`,
    expand: 'product_id,barber_id',
    sort: '-date',
  })
var getProductPurchases = (filter) =>
  pb.collection('product_purchases').getFullList({
    expand: 'product_id,client_id',
    sort: '-date',
    filter,
  })
var getClientLogs = (filter) =>
  pb.collection('client_logs').getFullList({
    sort: '-created',
    filter,
  })
var getCommissions = (filter) =>
...
export {
  ...
  getPackages as f,
  getProducts as g,
  getProductPurchasesByClient as h,
  getAppointmentsByClient as i,
  getClientPackages as l,
  getProductPurchases as m,
  createClient as n,
  getBusinessHours as o,
  getPaymentMethods as p,
  getAppointments as r,
  getCategories as s,
  createAppointment as t,
  getClients as u,
  updateAppointment as v,
  updateClient as y,
}

//# sourceMappingURL=api-Ev4o6R8r.js.map
