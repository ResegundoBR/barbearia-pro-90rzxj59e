...
import { t as Card } from './card-B4sC4G9b.js'
import {
  a as TableHeader,
  i as TableHead,
  n as TableBody,
...
function ServicesTab() {
  ...
  const loadData = async () => {
    setItems(
      await pb.collection('services').getFullList({
        sort: '-created',
        expand: 'category_id',
      }),
    )
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
            ...
            'data-prohibitions': '[editContent]',
            className:
              'flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full sm:w-auto',
            children: [
                      ...
                      TableRow,
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
                            ...
                            'data-prohibitions': '[editContent]',
                            children: item.expand?.category_id
                              ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                                ...
                                categories.map((c) =>
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                                    SelectItem,
                                    {
                                      ...
                                      'data-prohibitions': '[editContent]',
                                      value: c.id,
                                      children: [c.name, ' (', c.commission_percentage, '%)'],
                                    },
                                    c.id,
                                  ),
                                ),
...
function PackagesTab() {
  ...
  const loadData = async () => {
    setItems(
      await pb.collection('packages').getFullList({
        sort: '-created',
        expand: 'service_id',
      }),
    )
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
                      ...
                      children:
                        'Vincular um serviço permite que o sistema deduza automaticamente os usos deste pacote ao realizar o serviço correspondente no checkout.',
                    }),
                  ],
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
...
//# sourceMappingURL=Estoque-BkylrNQk.js.map
