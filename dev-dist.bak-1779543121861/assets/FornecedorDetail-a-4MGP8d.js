...
import { t as ArrowLeft } from './arrow-left-BaaBkxoq.js'
...
import { a as CardHeader, n as CardContent, o as CardTitle, t as Card } from './card-B4sC4G9b.js'
...
function FornecedorDetail() {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      setPurchases(
        await pb.collection('inventory_purchases').getFullList({
  ...
  const handleSavePurchase = async () => {
    ...
    try {
      ...
      if (purchaseForm.purchase_date) {
        ...
        if (!isNaN(d.getTime()))
          dateIso = /* @__PURE__ */ new Date(
            purchaseForm.purchase_date + 'T12:00:00.000Z',
          ).toISOString()
      }
      await pb.collection('inventory_purchases').create({
        ...
        received_at:
          purchaseForm.status === 'received' ? /* @__PURE__ */ new Date().toISOString() : null,
      })
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                        ...
                        children: [
                          supplier.expand?.category_id?.map((c) =>
                        ...
                        children: purchases.map((purch) => {
                          ...
                          return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                            'div',
                            {
                              ...
                              'data-prohibitions': '[editContent]',
                              className:
                                'flex flex-col sm:flex-row sm:items-center justify-between p-3 border rounded-lg hover:bg-muted/10 gap-3',
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                                  ...
                                  children: [
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                                      ...
                                      'data-prohibitions': '[]',
                                      className:
                                        'bg-primary/10 p-2 rounded-full mt-1 sm:mt-0 shrink-0',
                                          ...
                                          children: [
                                            ...
                                            status === 'pending'
                                              ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                                  ...
                                                  {
                                                    'data-uid':
                                                      'src/pages/FornecedorDetail.tsx:254:31',
                                                    'data-prohibitions': '[]',
                                                    className:
                                                      'bg-yellow-500/10 text-yellow-500 border border-yellow-500/20 text-[10px] font-medium px-2 py-0.5 rounded-full',
                                                    children: 'Pendente',
                                                  },
                                                )
                                              : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                                  ...
                                                  {
                                                    'data-uid':
                                                      'src/pages/FornecedorDetail.tsx:258:31',
                                                    'data-prohibitions': '[]',
                                                    className:
                                                      'bg-green-500/10 text-green-500 border border-green-500/20 text-[10px] font-medium px-2 py-0.5 rounded-full',
                                                    children: 'Recebido',
                                                  },
                                                ),
                                          ],
                                ...
                                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                                  ...
                                  'data-prohibitions': '[editContent]',
                                  className:
                                    'flex items-center justify-between sm:justify-end gap-4 w-full sm:w-auto mt-2 sm:mt-0 border-t sm:border-t-0 pt-2 sm:pt-0',
                                  children: [
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('p', {
                        ...
                        children: [
                          'Fornecedor: ',
                          lastPurchase.expand?.supplier_id?.name || 'Desconhecido',
                        ],
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('p', {
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('p', {
                        ...
                        children: [
                          'Data: ',
                          format(new Date(lastPurchase.purchase_date), 'dd/MM/yyyy'),
                        ],
                      }),
                    ],
                  }),
...
//# sourceMappingURL=FornecedorDetail-a-4MGP8d.js.map
