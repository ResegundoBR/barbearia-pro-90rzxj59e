...
import { t as Calendar } from './calendar-jJfFM0Em.js'
import { t as Calendar$1 } from './calendar-Bf0Mvo42.js'
import { t as CircleCheck } from './circle-check-BDMUXYFb.js'
import { t as DollarSign } from './dollar-sign-BKgDWPZq.js'
...
import { g as startOfWeek, p as startOfDay, t as format, v as toDate } from './format-BfI_WwAb.js'
import { t as startOfMonth } from './startOfMonth-2OCUkoeN.js'
import { n as endOfMonth, t as endOfWeek } from './endOfWeek-Bs8sjMGp.js'
import { t as subDays } from './subDays-D7_va67k.js'
import {
  d as getCommissions,
  l as getClientPackages,
  m as getProductPurchases,
  p as getPaymentMethods,
...
import { t as Checkbox } from './checkbox-CKxh59wc.js'
...
function Staff() {
  ...
  const getCommissionInfo = (type, itemId, barberId) => {
    ...
    if (type === 'service') {
      ...
      catRate =
        products.find((p) => p.id === itemId)?.expand?.category_id?.commission_percentage || 0
  ...
  const addCycle = () => {
    setForm((prev) => ({
      ...
      payment_schedule_config: {
        ...
        cycles: [
          ...(prev.payment_schedule_config?.cycles || []),
          {
            workDays: [],
            paymentDay: 1,
          },
  ...
  const handleConfirmPayment = async () => {
    ...
    try {
      ...
      receiptText += `\n\nObrigado!`
      const cleanPhone = (
        barberToPay?.expand?.user_id?.whatsapp ||
        barberToPay?.expand?.user_id?.phone ||
        ''
      ).replace(/\D/g, '')
      const url = cleanPhone
        ? `https://api.whatsapp.com/send?phone=55${cleanPhone}&text=${encodeURIComponent(receiptText)}`
  ...
  const ticketData = (0, import_react.useMemo)(() => {
    ...
    const matchedPm = paymentMethods.find(
      (p) => p.type === mapCommPayMethod(pmType) || p.name.toLowerCase() === pmType.toLowerCase(),
    )
    ...
    const paymentMethodName = ticketItem.packageUsed
      ? 'Uso de Pacote'
    ...
    children: [
                ...
                children: [
                  barbers.map((b) => {
                    ...
                    const displayPayDate = earliestDue
                      ...
                      : format(
                          getNextPayDate(/* @__PURE__ */ new Date(), b.payment_schedule_config),
                          'dd/MM/yyyy',
                        )
                      ...
                      TableRow,
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
                            ...
                            'data-prohibitions': '[editContent]',
                            children: b.expand?.user_id?.whatsapp
                            ...
                            children:
                              b.work_level === 'socio'
                                ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
                                    ...
                                    'data-prohibitions': '[]',
                                    className:
                                      'bg-emerald-600 hover:bg-emerald-700 text-white font-bold tracking-wide border-0 shadow-sm',
                      ...
                      children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableRow, {
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
                            ...
                            'data-prohibitions': '[]',
                            className:
                              'whitespace-nowrap sticky left-0 z-20 bg-background px-4 py-3 border-none',
                            children: '# Checkout',
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
                            ...
                            'data-prohibitions': '[]',
                            className:
                              'text-right whitespace-nowrap sticky right-0 z-20 bg-background px-4 py-3 border-none',
                            children: 'Ações',
                          }),
                        ],
                      }),
                        ...
                        displayedReportItems.map((item, i) =>
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                            TableRow,
                            {
                              ...
                              'data-prohibitions': '[editContent]',
                              className:
                                'group/row border-none hover:bg-muted/50 transition-colors',
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
                                  'data-uid': 'src/pages/Staff.tsx:1221:23',
                                  'data-prohibitions': '[editContent]',
                                  className:
                                    'font-mono text-muted-foreground sticky left-0 z-10 bg-background group-hover/row:bg-muted/50 transition-colors px-4 py-3 border-none',
                                ...
                                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableCell, {
                                  ...
                                  children: [format(item.date, 'dd/MM/yyyy'), ' às ', item.time],
                                }),
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
                                ...
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
                                  ...
                                  'data-prohibitions': '[]',
                                  className:
                                    'text-right sticky right-0 z-10 bg-background group-hover/row:bg-muted/50 transition-colors px-4 py-3 border-none',
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardDescription, {
                ...
                'data-prohibitions': '[]',
                children:
                  'As regras de vencimento agora são configuradas individualmente para cada profissional Autônomo.',
              }),
            ],
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                ...
                'data-prohibitions': '[]',
                className:
                  'p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg flex items-start gap-3',
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
                    ...
                    children:
                      'As datas da coluna "A Pagar" são calculadas automaticamente com base nos ciclos definidos no perfil de cada profissional.',
                  }),
                ],
              }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                ...
                'data-prohibitions': '[]',
                className:
                  'p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-lg flex items-start gap-3',
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                        ...
                        children: [
                          ...
                          form.payment_schedule_config?.cycles?.map((cycle, index) =>
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                              'div',
                              {
                                ...
                                children: [
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
                                    ...
                                    size: 'icon',
                                    className:
                                      'absolute right-2 top-2 h-6 w-6 text-destructive hover:bg-destructive/10',
                                  ...
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                                    ...
                                    children: [
                                      ...
                                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
                                        ...
                                        onValueChange: (v) =>
                                          updateCyclePaymentDay(index, parseInt(v)),
                                        children: [
                                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                            SelectTrigger,
                                            {
                          ...
                          (!form.payment_schedule_config?.cycles ||
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
                              ...
                              'data-prohibitions': '[]',
                              className:
                                'text-sm text-muted-foreground text-center py-2 border border-dashed rounded-md',
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
              ...
              'data-prohibitions': '[editContent]',
              className:
                'overflow-x-auto overflow-y-auto flex-1 mt-4 border rounded-md max-h-[40vh]',
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Table, {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
              ...
              'data-prohibitions': '[editContent]',
              className:
                'bg-white p-6 border-y-2 border-dashed border-gray-300 shadow-sm font-mono text-sm space-y-4 my-2 max-h-[50vh] overflow-y-auto',
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
                      ...
                      'data-prohibitions': '[editContent]',
                      children: format(
                        paymentReceiptDetails?.date || /* @__PURE__ */ new Date(),
                        'dd/MM/yyyy HH:mm',
                      ),
                    }),
                  ],
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                  ...
                  children: [
                    ...
                    paymentReceiptDetails?.items.some((i) => (i.amount || 0) < 0) &&
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                            ...
                            'data-prohibitions': '[]',
                            className:
                              'grid grid-cols-12 font-bold mt-4 mb-1 border-b border-gray-100 pb-1 text-red-800',
                            children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                  ...
                  'data-prohibitions': '[editContent]',
                  className:
                    'border-t border-dashed border-gray-300 pt-3 flex justify-between font-bold text-base',
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
          ...
          'data-prohibitions': '[editContent]',
          className:
            'sm:max-w-sm bg-white text-black font-mono shadow-xl max-h-[90vh] overflow-y-auto rounded-md border border-gray-300',
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogHeader, {
                    ...
                    children: [
                      ...
                      ticketData.checkoutNumber &&
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('p', {
                          ...
                          'data-prohibitions': '[editContent]',
                          className:
                            'text-lg font-black uppercase tracking-widest text-primary mt-1 mb-2',
                    ...
                    ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
                            ...
                            'data-prohibitions': '[]',
                            className:
                              'font-bold uppercase text-gray-800 text-xs mb-2 border-b pb-1',
                            children: 'Itens do Pedido (Snapshot)',
                          }),
                          ticketData.snapshot.map((sItem, idx) =>
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                              'div',
                              {
                        ...
                        children: [
                          ticketData.nonCommProducts.length > 0 &&
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                              ...
                              children: [
                                ...
                                ticketData.nonCommProducts.map((p, i) =>
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                                    'div',
                                    {
                          ...
                          ticketData.nonCommOthers.length > 0 &&
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                              ...
                              children: [
                                ...
                                ticketData.nonCommOthers.map((p, i) =>
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                                    'div',
                                    {
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                            ...
                            children: [
                              ...
                              ticketData.commissionableItems.map((i, idx) =>
                                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                                  'div',
                                  {
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
                        ...
                        'data-prohibitions': '[editContent]',
                        className:
                          'flex justify-between text-sm text-gray-600 mb-2 border-b border-gray-200 pb-1',
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
                      ...
                      ticketData.memoryLines.map((line, idx) =>
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                          'div',
                          {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogFooter, {
              ...
              'data-prohibitions': '[editContent]',
              className:
                'mt-4 flex-col sm:flex-col gap-2 border-t border-dashed border-gray-300 pt-4',
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                  'data-uid': 'src/pages/Staff.tsx:2031:13',
                  'data-prohibitions': '[editContent]',
                  className:
                    'w-full font-sans font-medium bg-[#F97316] hover:bg-[#EA580C] text-black border-none',
                  onClick: () => {
                    let text = `================================\n`
...
//# sourceMappingURL=Staff-DZDQVefy.js.map
