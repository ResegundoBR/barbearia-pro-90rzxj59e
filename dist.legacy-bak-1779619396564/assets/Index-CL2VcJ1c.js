...
import { t as a } from './clock-CXcmCz5Z.js'
import { t as o } from './dollar-sign-DgwHfhkA.js'
import { n as s, r as c, t as l } from './toggle-group-EynYOrG1.js'
import {
  J as u,
  S as d,
  X as f,
...
import { i as fe, n as pe, r as me, t as he } from './tabs-gFjfGirc.js'
import {
  a as ge,
  d as _e,
  g as ve,
  ...
  s as we,
  u as Te,
} from './api-DxhYzPjr.js'
import { a as N, n as P, o as F, t as Ee } from './card-CPm2bQdE.js'
import { a as De, i as I, n as Oe, o as L, r as R, t as ke } from './table-BQplVDEI.js'
import { t as Ae } from './badge-DDF6d_iC.js'
import { t as je } from './progress-CF5i_6Hm.js'
var Me = _(`circle-arrow-down`, [
    [`circle`, { cx: `12`, cy: `12`, r: `10`, key: `1mglay` }],
    [`path`, { d: `M12 8v8`, key: `napkw2` }],
    [`path`, { d: `m8 12 4 4 4-4`, key: `k98ssh` }],
  ]),
  Ne = _(`circle-arrow-up`, [
    [`circle`, { cx: `12`, cy: `12`, r: `10`, key: `1mglay` }],
  ...
  Wi = function (e) {
    ...
    return u === +u && d === +d && i === +i
      ? U.createElement(
          `path`,
          ji({}, f, {
            className: k(`recharts-symbols`, l),
...
var Fs = function (e) {
  var t = e.separator,
    ...
    x = !(0, V.default)(m),
    S = x ? m : ``,
    C = k(`recharts-default-tooltip`, f),
    w = k(`recharts-tooltip-label`, p)
  x && h && l != null && (S = h(m, l))
  var T = _ ? { role: `status`, 'aria-live': `assertive` } : {}
  return U.createElement(
    `div`,
    Ss({ className: C, style: y }, T),
    U.createElement(`p`, { className: w, style: b }, U.isValidElement(S) ? S : `${S}`),
    v(),
  )
}
function Is(e) {
...
var Jc = (0, U.forwardRef)(function (e, t) {
    ...
    var C = Hc((0, U.useState)({ containerWidth: i.width, containerHeight: i.height }), 2),
      w = C[0],
      T = C[1],
    ...
    return U.createElement(
      ...
      {
        id: g ? `${g}` : void 0,
        className: k(`recharts-responsive-container`, _),
  ...
  $l = function (e) {
    ...
    switch (m) {
      case `start`:
        ...
        break
      case `middle`:
        D = Fl(`calc(${(v.length - 1) / 2} * -${o} + (${c} / 2))`)
        break
      default:
        D = Fl(`calc(${v.length - 1} * -${o})`)
        break
    }
    var O = []
    if (u) {
    ...
    return (
      ...
      U.createElement(
        ...
        Rl({}, G(w, !0), {
          x: T,
          y: E,
          className: k(`recharts-text`, S),
          textAnchor: f,
          fill: g.includes(`url`) ? Ql : g,
        }),
        v.map(function (e, t) {
          var n = e.words.join(C ? `` : ` `)
          return U.createElement(`tspan`, { x: T, dy: t === 0 ? D : o, key: `${n}-${t}` }, n)
        }),
      )
    )
  }
...
var Kv = function (e) {
  ...
  Jv = function (e, t, n) {
    ...
    ;(r === `insideStart`
      ...
      (y = g <= 0 ? y : !y))
    var b = xv(c, l, h, v),
      x = xv(c, l, h, v + (y ? 1 : -1) * 359),
      S = `M${b.x},${b.y}
    A${h},${h},0,1,${+!y},
    ${x.x},${x.y}`,
      C = (0, V.default)(e.id) ? Zt(`recharts-radial-line-`) : e.id
    return U.createElement(
      `text`,
      Gv({}, n, { dominantBaseline: `central`, className: k(`recharts-radial-bar-label`, o) }),
      U.createElement(`defs`, null, U.createElement(`path`, { id: C, d: S })),
      U.createElement(`textPath`, { xlinkHref: `#${C}` }, t),
    )
  },
  Yv = function (e) {
    var t = e.viewBox,
...
function Qv(e) {
  ...
  var g = m ? Yv(i) : Xv(i)
  return U.createElement($l, Gv({ className: k(`recharts-label`, d) }, h, g, { breakAll: f }), p)
}
...
var Uy = {
  ...
  Yy = function (e) {
    ...
    return U.createElement(
      `path`,
      Ly({}, G(e, !1), pn(e), { className: k(`recharts-curve`, t), d: a, ref: i }),
    )
  },
  Xy = r((e, t) => {
...
var bC = function (e, t, n, r, i, a) {
  ...
  xC = function (e) {
    ...
    return !H(n) || !H(i) || !H(u) || !H(f) || !H(o) || !H(c)
      ...
      : U.createElement(
          `path`,
          fC({}, G(h, !0), { className: k(`recharts-cross`, p), d: bC(n, i, u, f, o, c) }),
        )
  },
  SC = r((e, t) => {
    var n = Ph(),
            ...
            var e = this,
              ...
              f = r.map(function (n, r) {
                ...
                return U.createElement(
                  ...
                  kC(
                    {
                      className: k(`recharts-polar-radius-axis-tick`, kv(i)),
        ...
        },
        {
          ...
          value: function () {
            ...
            return !t || !t.length
              ...
              : U.createElement(
                  K,
                  { className: k(`recharts-polar-radius-axis`, this.props.className) },
              ...
              var e = this,
                ...
                d = r.map(function (n, r) {
                  ...
                  return U.createElement(
                    ...
                    YC(
                      {
                        className: k(`recharts-polar-angle-axis-tick`, kv(i)),
                        key: `tick-${n.coordinate}`,
                      },
                      hn(e.props, n, r),
                    ),
          ...
          },
          {
            ...
            value: function () {
              ...
              return n <= 0 || !t || !t.length
                ...
                : U.createElement(
                    K,
                    { className: k(`recharts-polar-angle-axis`, this.props.className) },
      ...
      [
        ...
        },
        {
          ...
          value: function (e, t, n) {
            ...
            var r = k(`recharts-pie-label-line`, typeof e == `boolean` ? `` : e.className)
...
function iO(e) {
  ...
  return U.createElement(
    K,
    { className: k(`recharts-reference-line`, s) },
    nO(o, x),
      ...
      fO(t, [
        {
          ...
          value: function () {
            ...
            return U.createElement(
              K,
              { className: k(`recharts-reference-dot`, m) },
              t.renderDot(p, h),
        ...
        },
        {
          ...
          value: function () {
            ...
            return U.createElement(
              `line`,
              lk({}, c, {
                className: k(`recharts-cartesian-axis-line`, (0, Wt.default)(s, `className`)),
              }),
            )
          },
        },
      ...
      [
        {
          ...
          value: function (e, t, n) {
            var r,
              i = k(t.className, `recharts-cartesian-axis-tick-value`)
            return (
...
;((Zk = _A),
  ...
  mA(_A, `renderDotItem`, function (e, t) {
    ...
    if (U.isValidElement(e)) n = U.cloneElement(e, t)
      ...
      var r = k(`recharts-area-dot`, typeof e == `boolean` ? `` : e.className),
        i = t.key,
        a = $k(t, Xk)
...
function NA(e) {
  ...
  return i == null
    ...
    : U.createElement(
        Dk,
        MA({}, i, {
          className: k(`recharts-${i.axisType} ${i.axisType}`, i.className),
...
function Tj(e) {
  ...
  var v = xj(
    ...
    {},
    { payload: a, payloadIndex: s, className: k(`recharts-tooltip-cursor`, d.className) },
  )
            ...
            Q(r, `renderPolarAxis`, function (e, t, n) {
              ...
              return (0, U.cloneElement)(
                ...
                Z(
                  Z({}, c),
                  {},
                  { className: k(i, c.className), key: e.key || `${t}-${n}`, ticks: L_(c, !0) },
                ),
              )
            }),
    ...
    (
      ...
      let { config: h } = EM(),
        g = U.useMemo(() => {
          ...
          return s
            ? (0, $.jsx)(`div`, { className: u(`font-medium`, c), children: s(r, t) })
            : r
              ? (0, $.jsx)(`div`, { className: u(`font-medium`, c), children: r })
              : null
        }, [o, s, t, i, c, h, p])
      ...
      return (0, $.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, $.jsx)(`div`, {
            ...
            children: t.map((e, t) => {
              let n = MM(h, e, `${f || e.name || e.dataKey || `value`}`),
                i = d || e.payload.fill || e.color
              return (0, $.jsx)(
                `div`,
                {
                  className: u(
...
var jM = U.forwardRef(
  ({ className: e, hideIcon: t = !1, payload: n, verticalAlign: r = `bottom`, nameKey: i }, a) => {
    ...
    return n?.length
      ? (0, $.jsx)(`div`, {
          ref: a,
          className: u(`flex items-center justify-center gap-4`, r === `top` ? `pb-3` : `pt-3`, e),
          children: n.map((e) => {
            ...
            children: [
              (0, $.jsxs)(N, {
                ...
                children: [
                  ...
                  (0, $.jsx)(f, { className: `size-4 text-blue-500` }),
                ],
              }),
              (0, $.jsx)(P, {
                children: (0, $.jsxs)(`div`, {
...
function FM() {
  ...
  ;((0, U.useEffect)(() => {
    ...
    x(`appointments`, () => mt()),
    x(`client_packages`, () => mt()),
    x(`product_purchases`, () => mt()),
    x(`commissions`, () => mt()),
    x(`clients`, () => mt()),
    x(`payment_methods`, () => mt()),
    x(`checkouts`, () => mt()))
  let ht = (0, U.useMemo)(() => {
      let e = new Date()
      return Je === `today`
    ...
    z = o ? Xe : vt?.id || `all`,
    yt = (0, U.useMemo)(() => f.filter((e) => z === `all` || e.barber_id === z), [f, z]),
                ...
                (0, $.jsxs)(E, {
                  ...
                  children: [
                    (0, $.jsx)(v, {
                      ...
                      children: (0, $.jsx)(C, { placeholder: `Todos os Profissionais` }),
                    }),
                    (0, $.jsxs)(g, {
                      children: [
                        (0, $.jsx)(O, { value: `all`, children: `Todos os Profissionais` }),
                        le.map((e) => (0, $.jsx)(O, { value: e.id, children: e.name }, e.id)),
                      ],
                    }),
                  ],
                }),
                    ...
                    children: [
                      (0, $.jsxs)(N, {
                        ...
                        children: [
                          ...
                          (0, $.jsx)(D, { className: `size-4 text-emerald-500 shrink-0` }),
                        ],
                      }),
                      (0, $.jsx)(P, {
                        className: `px-4 pb-4`,
                    ...
                    children: [
                      (0, $.jsxs)(N, {
                        ...
                        children: [
                          ...
                          (0, $.jsx)(D, { className: `size-4 text-amber-500 shrink-0` }),
                        ],
                      }),
                      (0, $.jsx)(P, {
                        className: `px-4 pb-4`,
                    ...
                    children: [
                      (0, $.jsxs)(N, {
                        ...
                        children: [
                          ...
                          (0, $.jsx)(D, { className: `size-4 text-orange-500 shrink-0` }),
                        ],
                      }),
                      (0, $.jsx)(P, {
                        className: `px-4 pb-4`,
                          ...
                          Yt.length > 0 &&
                            (0, $.jsxs)(`div`, {
                              ...
                              children: [
                                ...
                                (0, $.jsx)(T, { className: `size-4 opacity-50` }),
                              ],
                            }),
                          (0, $.jsxs)(`div`, {
                          ...
                          (0, $.jsxs)(`div`, {
                            ...
                            children: [
                              (0, $.jsxs)(`div`, {
                                className: `flex items-center gap-3`,
                                children: [
                                  (0, $.jsx)(S, { className: `size-5 shrink-0` }),
                                  (0, $.jsx)(`div`, {
                                    children: (0, $.jsxs)(`p`, {
                                      className: `font-semibold text-sm`,
                    ...
                    (0, $.jsxs)(ke, {
                      ...
                      children: [
                        ...
                        (0, $.jsxs)(Oe, {
                          children: [
                            Lt.map((e) => {
                              let t = f.find((t) => t.client_id === e.id)
                              return (0, $.jsxs)(
                                L,
                                {
                                  children: [
