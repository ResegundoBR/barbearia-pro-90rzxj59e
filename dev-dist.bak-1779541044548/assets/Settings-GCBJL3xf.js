...
import { A as Close, F as Root, H as Input, I as Title, J as cn, L as Trigger, M as Description, N as Overlay, P as Portal, Q as Truck, R as WarningProvider, S as DialogTitle, U as Button, W as buttonVariants, Z as Users, _ as Dialog, a as pb, b as DialogFooter, bt as useToast, c as SelectContent, f as SelectTrigger, gt as createContextScope, ht as createSlottable, i as useAuth, j as Content, lt as createLucideIcon, n as useRealtime, p as SelectValue, r as usePermissions, s as Select, t as Label, tt as Package, u as SelectItem, v as DialogContent, vt as useComposedRefs, x as DialogHeader, yt as composeEventHandlers, z as createDialogScope } from "./index-CvpHv2Ny.js";
...
import { a as CardHeader, n as CardContent, o as CardTitle, r as CardDescription, t as Card } from "./card-CkI-50fb.js";
...
import { i as updateCategory, n as deleteCategory, r as getCategories, t as createCategory } from "./categories-DCL9PYAm.js";
		...
		if (importType === "clientes") {
			...
			for (let i = 0; i < data.length; i++) {
				...
				try {
					...
					if (row.Profissional) {
						const b = allBarbers.find((b) => b.name.toLowerCase() === row.Profissional.toLowerCase().trim());
