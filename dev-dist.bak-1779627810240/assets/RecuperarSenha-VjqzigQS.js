...
import { t as KeyRound } from "./key-round-N9-hBhoo.js";
import { H as createLucideIcon, b as Button, n as useAuth, ot as Link, y as Input } from "./index-DhBjxsn_.js";
...
function RecuperarSenha() {
	...
	const handleReset = async (e) => {
		...
		setIsLoading(false);
		if (res.error) setError("Ocorreu um erro ao tentar enviar o link de recuperação. Tente novamente mais tarde.");
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardDescription, {
						...
						"data-prohibitions": "[editContent]",
						children: isSuccess ? "Verifique sua caixa de entrada" : "Informe seu e-mail para receber um link de recuperação"
					})
				]
				...
				}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [error && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
//# sourceMappingURL=RecuperarSenha-VjqzigQS.js.map