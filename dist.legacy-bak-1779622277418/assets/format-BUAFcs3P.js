var e = 365.2425,
  ...
  i = 3600 * 24
;(i * 7, ((i * e) / 12) * 3)
var a = Symbol.for(`constructDateFrom`)
function o(e, t) {
  return typeof e == `function`
    ? e(t)
    : e && typeof e == `object` && a in e
      ? e[a](t)
      : e instanceof Date
        ? new e.constructor(t)
        : new Date(t)
...
function y(e) {
  return !((!v(e) && typeof e != `number`) || isNaN(+s(e)))
}
function b(e, t) {
  let n = s(e, t?.in)
...
function k(e) {
  return (t, n = {}) => {
    ...
    let o = a[0],
      ...
      c = Array.isArray(s) ? j(s, (e) => e.test(o)) : A(s, (e) => e.test(o)),
      l
  ...
  H = {
    ...
    B: function (e, t, n) {
      let r = e.getHours(),
        i
      switch (
        ((i = r >= 17 ? V.evening : r >= 12 ? V.afternoon : r >= 4 ? V.morning : V.night), t)
      ) {
        case `B`:
        case `BB`:
        case `BBB`:
    ...
    k: function (e, t, n) {
      let r = e.getHours()
      return (
        r === 0 && (r = 24), t === `ko` ? n.ordinalNumber(r, { unit: `hour` }) : z(r, t.length)
      )
    },
    m: function (e, t, n) {
...
function ee(e, t, n) {
  let r = te(e, t, n)
  if ((console.warn(r), Z.includes(e))) throw RangeError(r)
}
function te(e, t, n) {
...
function se(e, t, n) {
  let r = l(),
    ...
    o =
      ...
      0,
    c = s(e, n?.in)
  if (!y(c)) throw RangeError(`Invalid time value`)
  let u = t
    .match(re)
    .map((e) => {
      let t = e[0]
    ...
    .map((e) => {
      ...
      let t = e[0]
      if (t === `'`) return { isToken: !1, value: ce(e) }
      if (H[t]) return { isToken: !0, value: e }
      if (t.match(oe))
  ...
  let d = { firstWeekContainsDate: a, weekStartsOn: o, locale: i }
  return u
    .map((r) => {
      if (!r.isToken) return r.value
      let a = r.value
      ;((!n?.useAdditionalWeekYearTokens && $(a)) || (!n?.useAdditionalDayOfYearTokens && Q(a))) &&
        ee(a, t, String(e))
      let o = H[a[0]]
      return o(c, a, i.localize, d)
    })
    .join(``)
}
function ce(e) {
  let t = e.match(ie)
  return t ? t[1].replace(ae, `'`) : e
}
export {
  l as _,
  M as a,
