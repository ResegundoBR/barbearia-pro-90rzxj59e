...
import { J as r, V as i } from './index-Bf5nkyu_.js'
var a = e(t(), 1),
  o = n()
function s(e, t = []) {
  let n = []
...
var l = `Progress`,
  ...
  [p, m] = d(l),
  h = a.forwardRef((e, t) => {
    let { __scopeProgress: n, value: r = null, max: a, getValueLabel: s = v, ...c } = e
    ;(a || a === 0) && !x(a) && console.error(C(`${a}`, `Progress`))
    let l = x(a) ? a : u
    r !== null && !S(r, l) && console.error(w(`${r}`, `Progress`))
    let d = S(r, l) ? r : null,
      f = b(d) ? s(d, l) : void 0
    return (0, o.jsx)(p, {
      scope: n,
...
var T = h,
  E = _,
  D = a.forwardRef(({ className: e, value: t, ...n }, i) =>
    (0, o.jsx)(T, {
      ref: i,
