...
import { i as b, n as x, r as S, t as C } from './tabs-gFjfGirc.js'
import { t as w } from './card-CPm2bQdE.js'
import { a as T, i as E, n as D, o as O, r as k, t as A } from './table-BQplVDEI.js'
import { t as j } from './badge-DDF6d_iC.js'
import { t as M } from './switch-B9u8388b.js'
var N = e(t(), 1),
  P = n()
function F() {
  let [e, t] = (0, N.useState)([]),
    ...
    { toast: B } = y(),
    V = async () => {
      ;(t(await l.collection(`services`).getFullList({ sort: `-created`, expand: `category_id` })),
        S(await l.collection(`categories`).getFullList({ filter: `type='service'`, sort: `name` })))
    }
  ;(0, N.useEffect)(() => {
    V()
  }, [])
  let H = (e) => {
    ...
    U = async () => {
      try {
        ...
        ;(R
          ? (await l.collection(`services`).update(R, e),
            B({ title: `Serviço atualizado com sucesso!` }))
          : (await l.collection(`services`).create(e), B({ title: `Serviço criado com sucesso!` })),
          b(!1),
          V())
      } catch {
    ...
    W = async (e, t) => {
      try {
        ;(await l.collection(`services`).update(e, { is_active: !t }), V())
      } catch {
    ...
    children: [
              ...
              (0, P.jsxs)(m, {
                ...
                children: [
                  (0, P.jsx)(f, {
                    ...
                    children: (0, P.jsx)(p, { placeholder: `Todas Categorias` }),
                  }),
                  (0, P.jsxs)(d, {
                    children: [
                      (0, P.jsx)(g, { value: `all`, children: `Todas Categorias` }),
                      x.map((e) => (0, P.jsx)(g, { value: e.id, children: e.name }, e.id)),
                    ],
                  }),
                ],
              }),
      ...
      (0, P.jsx)(c, {
        ...
        children: (0, P.jsxs)(_, {
          ...
          children: [
            (0, P.jsx)(v, {
              children: (0, P.jsx)(o, { children: R ? `Editar Serviço` : `Novo Serviço` }),
            }),
            (0, P.jsxs)(`div`, {
                ...
                (0, P.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, P.jsxs)(`div`, {
                      className: `space-y-2`,
                      children: [
                        (0, P.jsx)(h, { children: `Categoria de Comissão` }),
                        (0, P.jsxs)(m, {
                          value: I.category_id,
                          onValueChange: (e) => L({ ...I, category_id: e }),
                          children: [
                            (0, P.jsx)(f, {
                              children: (0, P.jsx)(p, { placeholder: `Selecione...` }),
                            }),
                            (0, P.jsxs)(d, {
                              children: [
                                (0, P.jsx)(g, { value: `none`, children: `Nenhuma` }),
                                x.map((e) =>
                                  (0, P.jsxs)(
                                    g,
                                    {
                ...
                (0, P.jsxs)(`div`, {
                  ...
                  children: [
                    (0, P.jsxs)(`div`, {
                      className: `space-y-2`,
                      children: [
                        (0, P.jsx)(h, { children: `Duração (minutos)` }),
                        (0, P.jsx)(a, {
                          type: `number`,
                    ...
                    (0, P.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, P.jsx)(h, { children: `Serviço Ativo` }),
                      ],
                    }),
                  ],
                }),
...
function I() {
  let [e, t] = (0, N.useState)([]),
    ...
    { toast: R } = y(),
    z = async () => {
      ;(t(await l.collection(`packages`).getFullList({ sort: `-created`, expand: `service_id` })),
        b(await l.collection(`services`).getFullList({ sort: `name` })))
    }
  ;(0, N.useEffect)(() => {
    z()
  }, [])
  let B = (e) => {
    ...
    V = async () => {
      try {
        ...
        ;(I
          ? (await l.collection(`packages`).update(I, e),
            R({ title: `Pacote atualizado com sucesso!` }))
          : (await l.collection(`packages`).create(e), R({ title: `Pacote criado com sucesso!` })),
          S(!1),
          z())
      } catch {
    ...
    H = async (e, t) => {
      try {
        ;(await l.collection(`packages`).update(e, { is_active: !t }), z())
      } catch {
    ...
    children: [
      ...
      (0, P.jsx)(c, {
        ...
        children: (0, P.jsxs)(_, {
          ...
          children: [
            (0, P.jsx)(v, {
              children: (0, P.jsx)(o, { children: I ? `Editar Pacote` : `Novo Pacote` }),
            }),
            (0, P.jsxs)(`div`, {
              className: `space-y-4 py-4`,
              children: [
                (0, P.jsxs)(`div`, {
                  className: `space-y-2`,
                  children: [
                    (0, P.jsx)(h, { children: `Nome do Pacote` }),
                    (0, P.jsx)(a, {
                      value: C.name,
                ...
                (0, P.jsxs)(`div`, {
                  className: `space-y-2`,
                  children: [
                    (0, P.jsx)(h, { children: `Serviço Vinculado` }),
                    (0, P.jsxs)(m, {
                      value: C.service_id,
                      onValueChange: (e) => F({ ...C, service_id: e }),
                      children: [
                        (0, P.jsx)(f, {
                          children: (0, P.jsx)(p, { placeholder: `Selecione um serviço` }),
                        }),
                        (0, P.jsxs)(d, {
                          children: [
                            (0, P.jsx)(g, { value: `none`, children: `Nenhum` }),
                            n.map((e) => (0, P.jsx)(g, { value: e.id, children: e.name }, e.id)),
                          ],
                        }),
                      ],
                    }),
                ...
                (0, P.jsxs)(`div`, {
                  ...
                  children: [
                    (0, P.jsxs)(`div`, {
                      className: `space-y-2`,
                      children: [
                        (0, P.jsx)(h, { children: `Qtd. de Usos` }),
                        (0, P.jsx)(a, {
                          type: `number`,
                          value: C.quantity,
                    ...
                    (0, P.jsxs)(`div`, {
                      className: `space-y-2`,
                      children: [
                        (0, P.jsx)(h, { children: `Periodicidade` }),
                        (0, P.jsxs)(m, {
                          value: C.periodicity,
                          ...
                          children: [
                            ...
                            (0, P.jsxs)(d, {
                              children: [
                                (0, P.jsx)(g, { value: `semanal`, children: `Semanal` }),
                                (0, P.jsx)(g, { value: `quinzenal`, children: `Quinzenal` }),
                              ],
                            }),
                          ],
                        }),
                ...
                (0, P.jsxs)(`div`, {
                  ...
                  children: [
                    (0, P.jsxs)(`div`, {
                      className: `space-y-2`,
                      children: [
                        (0, P.jsx)(h, { children: `Preço Total (R$)` }),
                        (0, P.jsx)(a, {
                          type: `number`,
                          step: `0.01`,
                          value: C.price,
                    ...
                    (0, P.jsxs)(`div`, {
                      className: `space-y-2`,
                      children: [
                        (0, P.jsx)(h, { children: `Duração Padrão (min)` }),
                        (0, P.jsx)(a, {
                          type: `number`,
                ...
                (0, P.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, P.jsx)(h, { children: `Pacote Ativo` }),
                  ],
                }),
              ],
            }),
