...
import { R as i, U as a, nt as o, rt as s, st as c, z as l } from './index-CHmnQ-gm.js'
import {
  d as u,
  f as d,
  g as f,
...
var ne = c(`chevron-left`, [[`path`, { d: `m15 18-6-6 6-6`, key: `1wnfg3` }]])
...
function An({
  ...
  return (0, $.jsx)(kn, {
    ...
    classNames: {
      root: a(`w-fit`, f.root),
      months: a(`relative flex flex-col gap-4 md:flex-row`, f.months),
      month: a(`flex w-full flex-col gap-4`, f.month),
      nav: a(`absolute inset-x-0 top-0 flex w-full items-center justify-between gap-1`, f.nav),
      button_previous: a(
        l({ variant: i }),
      ...
      dropdown: a(`absolute inset-0 opacity-0`, f.dropdown),
      caption_label: a(
      ...
      weekdays: a(`flex`, f.weekdays),
      weekday: a(
        `text-muted-foreground flex-1 select-none rounded-md text-[0.8rem] font-normal`,
        f.weekday,
      ),
      week: a(`mt-2 flex w-full`, f.week),
      week_number_header: a(`w-[--cell-size] select-none`, f.week_number_header),
      week_number: a(`text-muted-foreground select-none text-[0.8rem]`, f.week_number),
      day: a(
      ...
      range_start: a(`bg-accent rounded-full`, f.range_start),
      range_middle: a(`rounded-full`, f.range_middle),
      range_end: a(`bg-accent rounded-full`, f.range_end),
      today: a(
        `bg-accent text-accent-foreground rounded-full data-[selected=true]:rounded-full`,
        f.today,
      ),
      outside: a(`text-muted-foreground aria-selected:text-muted-foreground`, f.outside),
      disabled: a(`text-muted-foreground opacity-50`, f.disabled),
      hidden: a(`invisible`, f.hidden),
      ...t,
    },
    components: {
      Root: ({ className: e, rootRef: t, ...n }) =>
        (0, $.jsx)(`div`, { 'data-slot': `calendar`, ref: t, className: a(e), ...n }),
      Chevron: ({ className: e, orientation: t, ...n }) =>
        t === `left`
          ? (0, $.jsx)(ne, { className: a(`size-4`, e), ...n })
          : t === `right`
            ? (0, $.jsx)(o, { className: a(`size-4`, e), ...n })
            : (0, $.jsx)(s, { className: a(`size-4`, e), ...n }),
      DayButton: jn,
