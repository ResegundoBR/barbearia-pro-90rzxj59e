...
var m = f(`triangle-alert`, [
  ...
  v = h.forwardRef((e, t) => {
    let { pressed: n, defaultPressed: r, onPressedChange: i, ...a } = e,
      [o, s] = p({ prop: n, onChange: i, defaultProp: r ?? !1, caller: _ })
...
var [T, E] = x(b),
  D = h.forwardRef((e, t) => {
    let { value: n, defaultValue: r, onValueChange: i = () => {}, ...a } = e,
      [o, s] = p({ prop: n, defaultProp: r ?? ``, onChange: i, caller: b })
    return (0, g.jsx)(T, {
  ...
  O = h.forwardRef((e, t) => {
    let { value: n, defaultValue: r, onValueChange: i = () => {}, ...a } = e,
      [o, s] = p({ prop: n, defaultProp: r ?? [], onChange: i, caller: b }),
      c = h.useCallback((e) => s((t = []) => [...t, e]), [s]),
      l = h.useCallback((e) => s((t = []) => t.filter((t) => t !== e)), [s])
    return (0, g.jsx)(T, {
      scope: e.__scopeToggleGroup,
      type: `multiple`,
      value: o,
    ...
    return (0, g.jsx)(k, {
      ...
      children: o
        ? (0, g.jsx)(a, {
            ...
            dir: p,
            loop: u,
            children: (0, g.jsx)(c.div, { ...m, ref: t }),
          })
        : (0, g.jsx)(c.div, { ...m, ref: t }),
    })
  }),
  M = `ToggleGroupItem`,
  N = h.forwardRef((e, t) => {
...
var P = h.forwardRef((e, t) => {
  ...
  R = h.forwardRef(({ className: e, variant: t, size: n, ...r }, i) =>
    (0, g.jsx)(y, { ref: i, className: o(L({ variant: t, size: n, className: e })), ...r }),
  )
R.displayName = y.displayName
var z = h.createContext({ size: `default`, variant: `default` }),
  B = h.forwardRef(({ className: e, variant: t, size: n, children: r, ...i }, a) =>
    (0, g.jsx)(F, {
      ref: a,
...
var V = h.forwardRef(({ className: e, children: t, variant: n, size: r, ...i }, a) => {
  let s = h.useContext(z)
  return (0, g.jsx)(I, {
    ref: a,
    className: o(L({ variant: s.variant || n, size: s.size || r }), e),
    ...i,
    children: t,
  })
})
