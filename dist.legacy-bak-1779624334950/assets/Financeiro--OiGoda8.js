...
import { a as w, n as T, o as E, r as D, t as O } from './card-DHbyifQZ.js'
import { a as k, i as A, n as j, o as M, r as N, t as P } from './table-C_vNdqXn.js'
import { t as F } from './switch-CgEkKv2C.js'
var I = e(t(), 1),
  L = n()
function R() {
  let { user: e } = h(),
    ...
    G = async () => {
      try {
        R(await d.collection(`payment_methods`).getFullList({ sort: `name` }))
      } catch (e) {
        console.error(e)
      }
    },
    { hasAccess: K, isAdmin: q } = v(),
    J = q || K(`financeiro`)
  if (
    ((0, I.useEffect)(() => {
      J && G()
  ...
  let Y = (e) => {
    ...
    X = async () => {
      try {
        ...
        ;(V
          ? (await d.collection(`payment_methods`).update(V, e), t({ title: `Método atualizado!` }))
          : (await d.collection(`payment_methods`).create(e), t({ title: `Método criado!` })),
          B(!1),
          G())
      } catch {
    ...
    Z = async (e) => {
      if (confirm(`Remover este método de pagamento?`))
        try {
          ;(await d.collection(`payment_methods`).delete(e), t({ title: `Removido` }), G())
        } catch {
    ...
    Q = async (e, n) => {
      try {
        ;(await d.collection(`payment_methods`).update(e, { is_active: n }), G())
      } catch {
    ...
    children: [
      ...
      (0, L.jsx)(l, {
        ...
        children: (0, L.jsxs)(S, {
          children: [
            (0, L.jsx)(C, {
              children: (0, L.jsx)(c, { children: V ? `Editar Método` : `Novo Método` }),
            }),
            (0, L.jsxs)(`div`, {
              ...
              children: [
                (0, L.jsxs)(`div`, {
                  className: `space-y-2`,
                  children: [
                    (0, L.jsx)(b, { children: `Nome do Método` }),
                    (0, L.jsx)(o, {
                          ...
                          children: [
                            ...
                            (0, L.jsxs)(p, {
                              children: [
                                ...
                                (0, L.jsx)(x, { value: `pix`, children: `Pix` }),
                                (0, L.jsx)(x, { value: `cash`, children: `Dinheiro` }),
                                (0, L.jsx)(x, { value: `other`, children: `Outro` }),
                              ],
                            }),
                          ],
                        }),
                ...
                (0, L.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, L.jsx)(b, { children: `Ativo no Checkout` }),
                  ],
                }),
              ],
            }),
