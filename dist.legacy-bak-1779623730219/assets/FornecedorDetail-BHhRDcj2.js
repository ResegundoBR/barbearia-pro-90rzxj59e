...
import { t as r } from './arrow-left-Bqfdb4AN.js'
import { t as i } from './calendar-BR4UPgGk.js'
import {
  Ct as a,
  H as o,
  S as s,
...
import { a as E, n as D, o as O, t as k } from './card-CPm2bQdE.js'
...
function N() {
      ...
      if (e)
        try {
          ;(n(await u.collection(`suppliers`).getOne(e, { expand: `category_id` })),
            N(
              await u.collection(`inventory_purchases`).getFullList({
  ...
  let J = async () => {
      ...
      try {
        ...
        ;(await u.collection(`inventory_purchases`).create({
          supplier_id: e,
